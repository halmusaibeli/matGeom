function above = isAbovePlane(point, varargin)
%ISBELOWPLANE Test whether a point is below or above a plane.
%
%   BELOW = isAbovePlane(POINT, PLANE)
...
%
%   Example
%   isAbovePlane([1 1 1], createPlane([1 2 3], [1 1 1]))
%   ans =
%       1
%   isAbovePlane([3 3 3], createPlane([1 2 3], [1 1 1]))
%   ans =
%       0
%
%   See also
...
% normal, and returns true for points locatd above the plane (pos>=0).
above = linePosition3d(point, [plane(:, 1:3) planeNormal(plane)]) >= 0;
